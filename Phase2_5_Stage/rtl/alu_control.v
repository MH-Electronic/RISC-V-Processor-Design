module alu_control (
    ...
    always @(*) begin
        case (alu_op)
            ...
            2'b01: begin
                case (funct3)
                    3'b100, 3'b101: alu_control = 5'b00111; // BLT/BGE  → SLT (signed)
                    3'b110, 3'b111: alu_control = 5'b01001; // BLTU/BGEU → SLTU (unsigned)
                    default:        alu_control = 5'b00110; // BEQ/BNE  → SUB
                endcase
            end
